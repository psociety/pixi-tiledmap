...
let STATE_COUNT = 0;
let STATE_START = STATE_COUNT++;
let STATE_MAP = STATE_COUNT++;
let STATE_COLLECT_PROPS = STATE_COUNT++;
let STATE_COLLECT_ANIMATIONS = STATE_COUNT++;
let STATE_COLLECT_OBJECT_GROUPS = STATE_COUNT++;
let STATE_WAIT_FOR_CLOSE = STATE_COUNT++;
let STATE_TILESET = STATE_COUNT++;
let STATE_TILE = STATE_COUNT++;
let STATE_TILE_LAYER = STATE_COUNT++;
let STATE_OBJECT_LAYER = STATE_COUNT++;
let STATE_OBJECT = STATE_COUNT++;
let STATE_TILE_OBJECT = STATE_COUNT++;
let STATE_IMAGE_LAYER = STATE_COUNT++;
let STATE_TILE_DATA_XML = STATE_COUNT++;
let STATE_TILE_DATA_CSV = STATE_COUNT++;
let STATE_TILE_DATA_B64_RAW = STATE_COUNT++;
let STATE_TILE_DATA_B64_GZIP = STATE_COUNT++;
let STATE_TILE_DATA_B64_ZLIB = STATE_COUNT++;
let STATE_TERRAIN_TYPES = STATE_COUNT++;
let STATE_TERRAIN = STATE_COUNT++;
